...
//        mFragmentTransaction.commit();
       ...
       // mFragmentTransaction.add(R.id.container,mIndicadorGastoFragment,"");
        //mFragmentTransaction.commit();

///        getSupportFragmentManager().beginTransaction()
//                .add(R.id.container, new MenuFragment())
//                .commit();
//            getSupportFragmentManager().findFragmentById(R.id.chart_applications_distribution);
//
//        this.mView = (View) findViewById(R.id.container);
//        mView = new View(getFragmentManager(), IndicadorGastoFragment);
