...
import com.example.ferra.coretoadmin.aplication.basepresenter.activity.AlterarCadastroActivity;
...
public class AlterarCadastroController extends BaseActivityController<AlterarCadastroActivity> {


    public AlterarCadastroController(AlterarCadastroActivity activity) {
        super(activity);
    }
